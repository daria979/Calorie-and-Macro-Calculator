...
function activityLevel(result)
{
  ...
  if(activity1.selected)
  result *= 1.2;
  else if(activity2.selected)
  result *=1.375;
  else if(activity3.selected)
  result *=1.55;
  else if(activity4.selected)
  result *=1.725;
  else if(activity5.selected)
  result *=1.9;
...
function goal_checked(result)
{
  ...
  if(fat_loss.selected)
    result *= 0.75;
  else if(muscle_gain.selected)
    result *= 1.25;
